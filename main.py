...
class BarberShopApp:
    ...
    def build_tab_estoque(self):
        ...
        Label(self.frame_tabela, text="Buscar Produto:", bg=self.COLOR_BG, fg=self.COLOR_TEXT).pack(pady=5)
        self.search_entry = Entry(self.frame_tabela, bg='white', fg='black', insertbackground='black')
